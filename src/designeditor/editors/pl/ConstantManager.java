...
public final class ConstantManager {
	...
	public static final String ADD_DEFINE_VAR_BLOCK = "変数宣言Brock追加";
	public static final String ADD_FORMULA_BLOCK = "計算式Brock追加";
	public static final String ADD_CALL_BLOCK = "呼出Brock追加";
	public static final String ADD_RETURN_BLOCK = "Return Brock追加";
